...
@WebServlet(name = "RemoveCartItemServlet", urlPatterns = {"/remove-item"})
public class RemoveCartItemServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// get request data
		Gson gson = new Gson();
		Map<String, Integer> requestData = gson.fromJson(request.getReader(), new TypeToken<Map<String, Integer>>(){}.getType());
		...
		try {
			...
			CartDAO.removeFromCart(user.getEmail(), requestData.get("id"));
			
			// update response body
			responseBody.replace("cart-update", "successful");
			responseBody.put("item-removed", requestData.get("id"));
